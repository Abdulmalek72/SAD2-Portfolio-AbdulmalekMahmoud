...
public class CalculatorTest {
    ...
    void testAddPositiveIntegers() {
        assertEquals(8, calculate(5, 3, "+"), DELTA, "TC-A01 Failed: 5 + 3 should be 8");
    }

    // TC-A02: Basic Subtraction (Positive Integers)
    @Test
    void testSubtractPositiveIntegers() {
        assertEquals(6, calculate(10, 4, "-"), DELTA, "TC-A02 Failed: 10 - 4 should be 6");
    }
    ...
    void testDivideZeroByZero() {
        assertTrue(Double.isNaN(calculate(0, 0, "/")), "TC-A25 Failed: 0 / 0 should be NaN based on CalculatorModel implementation");
    }
